...
// Count total interested students
...
<header class="site-header">
    <div class="header-inner">
        <a href="/student-course-hub/admin/index.php" class="site-logo">
            SCH Admin Panel
        </a>
...
<main id="main-content" class="admin-main">
    <div class="admin-container">
        ...
        <div class="quick-links">
            <h2>Quick Actions</h2>
            <a href="/student-course-hub/admin/programmes.php" class="btn">Manage Programmes</a>
            <a href="/student-course-hub/admin/students.php" class="btn">View Interested Students</a>
            <a href="/student-course-hub/admin/modules.php" class="btn">Manage Modules</a>
        </div>
...
<footer class="site-footer">
    <p>&copy; <?= date('Y') ?> Student Course Hub — CTEC2712N</p>
</footer>
