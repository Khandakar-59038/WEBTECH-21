...
-- Programmes (IsPublished = 1 makes them visible on the student site)
...
INSERT INTO ProgrammeModules (ProgrammeID, ModuleID, Year) VALUES
-- BSc Computer Science (ID 1) — Year 1
(1, 1, 1), (1, 2, 1), (1, 3, 1), (1, 4, 1),
...
-- BSc Software Engineering (ID 2) — Year 1
(2, 1, 1), (2, 2, 1), (2, 3, 1), (2, 4, 1),
...
-- BSc Artificial Intelligence (ID 3) — Year 1
(3, 1, 1), (3, 2, 1), (3, 3, 1), (3, 4, 1),
-- BSc Artificial Intelligence — Year 2
(3, 5, 2), (3, 9, 2), (3, 8, 2), (3, 10, 2),
-- BSc Artificial Intelligence — Year 3
(3, 13, 3), (3, 15, 3), (3, 16, 3), (3, 18, 3),

-- BSc Cyber Security (ID 4) — Year 1
(4, 1, 1), (4, 2, 1), (4, 3, 1), (4, 4, 1),
-- BSc Cyber Security — Year 2
(4, 7, 2), (4, 10, 2), (4, 11, 2), (4, 17, 2),
-- BSc Cyber Security — Year 3
(4, 15, 3), (4, 16, 3), (4, 17, 3), (4, 18, 3),

-- BSc Data Science (ID 5) — Year 1
(5, 1, 1), (5, 2, 1), (5, 3, 1), (5, 4, 1),
-- BSc Data Science — Year 2
(5, 5, 2), (5, 6, 2), (5, 9, 2), (5, 16, 2),
-- BSc Data Science — Year 3
(5, 9, 3), (5, 14, 3), (5, 16, 3), (5, 18, 3),

-- MSc Machine Learning (ID 6)
(6, 19, 1), (6, 24, 1), (6, 27, 1), (6, 29, 1), (6, 31, 1),

-- MSc Cyber Security (ID 7)
(7, 20, 1), (7, 26, 1), (7, 30, 1), (7, 23, 1), (7, 31, 1),

-- MSc Data Science (ID 8)
(8, 21, 1), (8, 22, 1), (8, 27, 1), (8, 28, 1), (8, 31, 1),

-- MSc Artificial Intelligence (ID 9)
(9, 19, 1), (9, 24, 1), (9, 28, 1), (9, 29, 1), (9, 31, 1),

-- MSc Software Engineering (ID 10)
(10, 23, 1), (10, 22, 1), (10, 25, 1), (10, 26, 1), (10, 31, 1);
...
-- ── NOTE: Admin user ─────────────────────────────────────────────────────
-- Do NOT add the admin user here.
-- Add it manually using makepassword.php — see Part J of the guide.
-- INSERT INTO Admins (Username, PasswordHash, Role)
-- VALUES ('admin', 'PASTE_BCRYPT_HASH_HERE', 'superadmin');
